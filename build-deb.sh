...
docker build -f deb.Dockerfile -t devcontainer-packager .
...
envsubst '$AUTHOR_NAME $AUTHOR_EMAIL $SRC_FOLDER $PACKAGE_NAME $PACKAGE_VERSION'<$this_dir/buildscript.sh |\
